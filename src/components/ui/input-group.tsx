  ...
  return (
    <Input
      ...
      className={cn(
        ...
        // SOLUSI UNTUK AUTOFILL BROWSER:
        "autofill:bg-transparent autofill:transition-colors autofill:duration-[9999s]",
        // Jika teksnya berubah jadi hitam/tidak kontras saat autofill, tambahkan ini untuk memaksa warna teks:
