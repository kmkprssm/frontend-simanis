...
import { RisikoDitutupTab } from "@/components/pemantauan-tinjauan/tabs/risiko-ditutup";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Pemantauan & Tinjauan - Risiko Ditutup",
...
export default async function RisikoDitutupPage() {
  const queryClient = getQueryClient();

  await queryClient.prefetchInfiniteQuery({
    queryKey: ["risks", "monitoring", "closed", ""],
    initialPageParam: 1,
